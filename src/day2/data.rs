pub const REAL_DATA: &'static str = "Game 1: 13 green, 3 red; 4 red, 9 green, 4 blue; 9 green, 10 red, 2 blue
...
pub const PRACTICE_STRING_1: &'static str = "Game 1: 3 blue, 4 red; 1 red, 2 green, 6 blue; 2 green
...
pub const MAXES: Maxes = Maxes {
    red: 12,
    green: 13,
    blue: 14,
};

// pub const PRACTICE_STRING_2: &'static str = "";
